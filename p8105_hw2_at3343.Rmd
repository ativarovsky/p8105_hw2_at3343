...
Now we create a table for the most popular boys' name over time. First we use "arrange" to figure out the name, then we follow the same process as the Olivia table. 
