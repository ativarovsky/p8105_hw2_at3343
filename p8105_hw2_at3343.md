...
Now we create a table for the most popular boys’ name over time. First
we use “arrange” to figure out the name, then we follow the same process
as the Olivia table.

``` r
boys_name = 
  filter(pop_names, gender == "MALE") %>% 
  select(-gender) %>% 
  arrange(desc(year_of_birth), ethnicity, desc(count))
  
boys_name
```

    ## # A tibble: 5,963 x 5
    ##    year_of_birth ethnicity                  childs_first_name count  rank
    ##            <dbl> <chr>                      <chr>             <dbl> <dbl>
    ##  1          2016 ASIAN AND PACIFIC ISLANDER ETHAN               193     1
    ##  2          2016 ASIAN AND PACIFIC ISLANDER RYAN                160     2
    ##  3          2016 ASIAN AND PACIFIC ISLANDER MUHAMMAD            157     3
    ##  4          2016 ASIAN AND PACIFIC ISLANDER LUCAS               148     4
    ##  5          2016 ASIAN AND PACIFIC ISLANDER JAYDEN              138     5
    ##  6          2016 ASIAN AND PACIFIC ISLANDER AIDEN               133     6
    ##  7          2016 ASIAN AND PACIFIC ISLANDER DANIEL               81     7
    ##  8          2016 ASIAN AND PACIFIC ISLANDER EVAN                 77     8
    ##  9          2016 ASIAN AND PACIFIC ISLANDER JASON                76     9
    ## 10          2016 ASIAN AND PACIFIC ISLANDER LIAM                 76     9
